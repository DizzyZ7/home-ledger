...
class _ItemDetailBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final purchase = item.purchaseDate == null ? l10n.noValue : localizations.formatMediumDate(item.purchaseDate!);
    final warranty = item.warrantyExpiresAt == null ? l10n.noWarranty : localizations.formatMediumDate(item.warrantyExpiresAt!);
          ...
          Card(
            child: ListTile(
              ...
              leading: CircleAvatar(
                radius: 28,
                child: Text(item.name.isEmpty ? '?' : item.name.substring(0, 1).toUpperCase()),
              ),
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _DetailRow(label: l10n.purchaseDate, value: purchase),
