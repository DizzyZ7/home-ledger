...
class _ItemFormScreenState extends ConsumerState<ItemFormScreen> {
  ...
  Future<void> _pickDate(DateTime? value, ValueChanged<DateTime?> onChanged) async {
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _DateField(
                label: _dateLabel(l10n.purchaseDate, _purchaseDate),
                hasValue: _purchaseDate != null,
                onPick: () => _pickDate(_purchaseDate, (date) => _purchaseDate = date),
                onClear: () => setState(() => _purchaseDate = null),
              ),
              const SizedBox(height: 12),
              _DateField(
                label: _dateLabel(l10n.warrantyUntil, _warrantyDate),
                hasValue: _warrantyDate != null,
                onPick: () => _pickDate(_warrantyDate, (date) => _warrantyDate = date),
  ...
  String _dateLabel(String label, DateTime? date) {
    return date == null ? label : '$label: ${MaterialLocalizations.of(context).formatMediumDate(date)}';
  }
}
