...
extension HouseholdLocalizations on BuildContext {
  ...
  String get householdCreated => l10n.languageCode == 'ru'
      ? 'Новый дом создан и выбран.'
      : 'New household created and selected.';

  String get householdRenamed => l10n.languageCode == 'ru'
      ? 'Название дома обновлено.'
